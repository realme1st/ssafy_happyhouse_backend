    ...
    <form method="post" action="/user/regist">
	    <div class="bg-secondary p-5">
	        <div class="container bg-light col-sm-6 rounded-lg p-4">
	            ...
	            <input type="text" class="form-control mb-2" name="id" id="id" required>
	            <label for="pw">비밀번호<span class="text-danger">*</span></label>
	            <input type="password" class="form-control mb-2" name="pw" id="pw" placeholder="영문 숫자 포함 6자리 이상" required>
	            <label for="addr">주소<span class="text-danger">*</span></label>
	            <input type="text" class="form-control mb-2" name="addr" id="addr" placeholder="address" required>
	            <label for="phoneNm">전화번호<span class="text-danger">*</span></label>
	            <input type="text" class="form-control mb-2" name="phoneNm" id="phoneNm" placeholder="010-xxx-xxxx" required>
	            <label for="name">이름<span class="text-danger">*</span></label>
	            <input type="text" class="form-control mb-2" name="name" id="name" placeholder="User Name" required>
